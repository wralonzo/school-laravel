...
@section('page_title', 'Agregar Estudiante')
@section('content')
<div class="card">
  <div class="card-header bg-white header-elements-inline">
    <h6 class="card-title">Por favor llenar el siguiente formulario</h6>
  ...
  <form id="ajax-reg" method="post" enctype="multipart/form-data" class="wizard-form steps-validation" action="{{ route('students.store') }}" data-fouc>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="email" value="{{ old('email') }}" name="email" class="form-control" placeholder="Correo elctrónico">
          </div>
        </div>
    ...
    <fieldset>
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            <label for="my_class_id">Clase: <span class="text-danger">*</span></label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="section_id">Sección: <span class="text-danger">*</span></label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="my_parent_id">Padres: </label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="year_admitted">Año adminisión: <span class="text-danger">*</span></label>
      ...
      <div class="row">
        <!-- <div class="col-md-3">
          <label for="dorm_id">Dormitorio: </label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label>Número de adminisión:</label>
