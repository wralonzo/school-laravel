...
<div class="card">
  <div class="card-header bg-white header-elements-inline">
    <h6 id="ajax-title" class="card-title">Editar el formulario del {{ $sr->user->name }}</h6>
  ...
  <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" data-reload="#ajax-title" action="{{ route('students.update', Qs::hash($sr->id)) }}" data-fouc>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select class="select form-control" id="gender" name="gender" required data-fouc data-placeholder="Choose..">
              ...
              <option {{ ($sr->user->gender  == 'Female' ? 'selected' : '') }} value="Female">Femenino</option>
            </select>
          </div>
        </div>
    ...
    <h6>Información Estudiante</h6>
    <fieldset>
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            <label for="my_class_id">Clase: </label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="my_parent_id">Padre: </label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="year_admitted">Año de Admisión: </label>
