                ...
                <form class="login-form " method="post" action="{{ route('login') }}">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="form-group ">
                                <input required name="password" type="password" class="form-control" placeholder="{{ __('Contraseña') }}">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">Loguearte <i class="icon-circle-right2 ml-2"></i></button>
                            </div>
